...
<style>
    ...
    cursor: not-allowed; /* con trỏ chuột dạng cấm */
}
                    ...
                    <div class="product-details-wrap">
                        ...
                        <div class="pd-quick-discription">
                            ...
                            <li class="d-flex align-items-center">
                                ...
                                <div class="size-option d-flex align-items-center">
                                    @foreach ($sizeValues as $size)
                                        ...
                                        <input type="radio" name="size" id="size{{ $size->id }}" value="{{ $size->value }}">
                            ...
                            <li class="mt-2 text-left">
                                <button id="js-reset-selection" class="btn btn-outline-secondary btn-sm">Reset</button>
                            </li>

                                <li class="d-flex align-items-center pd-cart-btns">
                                <div class="quantity-group">
    <button type="button" class="qty-btn qty-minus">−</button>
    <input type="number" id="product-quantity" min="1" max="10" step="1" value="1" readonly>
    ...
    btnMinus.addEventListener('click', function () {
        ...
        function updatePrice() {
            ...
            let matchedVariation = variations.find(v => {
                const colorMatch = selectedColor ? v.attributes.some(attr => attr.attribute_id === 2 && attr.value === selectedColor) : true;
                const sizeMatch = selectedSize ? v.attributes.some(attr => attr.attribute_id === 1 && attr.value === selectedSize) : true;
            ...
            if (hasSize) {
                document.querySelectorAll('input[name="size"]').forEach(input => {
                    ...
                    const matched = variations.find(v =>
                        ...
                        (!selectedColor || v.attributes.some(attr => attr.attribute_id === 2 && attr.value === selectedColor))
                    );
            ...
            if (hasColor) {
                document.querySelectorAll('input[name="color"]').forEach(input => {
                    ...
                    const matched = variations.find(v =>
                        ...
                        (!selectedSize || v.attributes.some(attr => attr.attribute_id === 1 && attr.value === selectedSize))
                    );
        ...
        if (resetBtn) {
            resetBtn.addEventListener('click', () => {
                document.querySelectorAll('input[name="color"]:checked, input[name="size"]:checked').forEach(input => {
                    input.checked = false;
                });
